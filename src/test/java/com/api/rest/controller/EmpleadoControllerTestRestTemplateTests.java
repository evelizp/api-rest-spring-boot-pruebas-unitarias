...
public class EmpleadoControllerTestRestTemplateTests {
    ...
    void testGuardarEmpleado(){
        ...
        assertEquals("Ericson",empleadoCreado.getNombre());
        assertEquals("Veliz",empleado.getApellido());
        assertEquals("e1@gmail.com",empleadoCreado.getEmail());
    ...
    void testListarEmpleado(){
        ...
        assertEquals("Ericson",empleados.get(0).getNombre());
        assertEquals("Veliz",empleados.get(0).getApellido());
        assertEquals("e1@gmail.com",empleados.get(0).getEmail());
    ...
    void testObtenerEmpleado(){
        ...
        assertEquals("Ericson",empleado.getNombre());
        assertEquals("Veliz",empleado.getApellido());
        assertEquals("e1@gmail.com",empleado.getEmail());
    }
